...
then
    ...
    java -jar revanced-cli.jar -m revanced-integrations.apk -b revanced-patches.jar --experimental  \
                               -e amoled -e custom-branding -e hide-video-buttons -e disable-create-button -e hide-autoplay-button -e disable-fullscreen-panels -e old-quality-layout -e hide-shorts-button -e hide-watermark -e enable-wide-searchbar -e always-autorepeat -e hide-time-and-seekbar -a com.google.android.youtube.apk -o build/revanced-nonroot.apk
else
